...
retStereo, cameraM_matrix_stereo, dist_coeffsM_stereo, cameraS_matrix_stereo, dist_coeffsS_matrix_stereo, rot_stereo, tvecs_stereo, essentialMatrix, fundamentalMatrix = cv.stereoCalibrate(
    objpoints, 
